...
// Use recursion.  Do NOT use any kind of loop. 
  ...
  protected void downheapRec2(int p, int c)

  {

  if(compare(heap.get(p), heap.get(c)) > 0)
...
// You may use loops in this method.
  ...
  PQEntry currentEntry = (PQEntry) heap.get(i);

  currentEntry.setKey(newKey);

 

  if((int) newKey > (int) currentKey)
